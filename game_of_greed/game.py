...
class Game:
    ...
    """
    Description:
    This class represent the core of Game Of Greed which contains:
        ...
        if wanna_play == "n" or wanna_play == "no":
            ...
            if keep_q == "q" or keep_q == "quit":
                ...
                shelfed_points = self.banker.shelf(
                    new_game.calculate_score(earned_points))
                print(
                    f"You have {shelfed_points} unbanked points and {dices_left} dice remaining")
